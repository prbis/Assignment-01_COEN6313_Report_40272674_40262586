...
async function main() {
  ...
  for (let i = 1; i <= totalRuns; i++) {
    ...
    // // --- Query 0: GetPrizesByCategory ---
    // const delay1 = await measureDelay('GetPrizesByCategory', {});
    // delays.query0.push(delay1);
    // console.log(`  Query0 (GetPrizesByCategory) Delay: ${delay1.toFixed(2)} ms`);
    ...
    delays.query3.push(delay4);
    console.log(`  Query3 (GetLaureateDetailsByName) Delay: ${delay4.toFixed(2)} ms\n`);
