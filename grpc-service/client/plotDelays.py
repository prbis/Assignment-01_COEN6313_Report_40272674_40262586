...
delays_file = 'delays_2024-10-26T18-06-02-745Z.json'  # Replace with your actual file name
...
query_names = {
    ...
    'query1': 'CountLaureatesByCategoryAndYearRange',
    'query2': 'CountLaureatesByMotivationKeyword',
    'query3': 'GetLaureateDetailsByName'
}
...
plt.ylabel('Delay (ms)')
plt.ylim(60,150)  # Set y-axis limits to 0 to 100
